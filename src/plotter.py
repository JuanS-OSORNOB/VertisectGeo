...
class VerticalSection:
    ...
    def draw_cross_section(self, ax, projected_data, profile_depth, title):
        ...
        ax.scatter(projected_data["Profile_X"], projected_data["Depth"], c = projected_data["Color"], s = projected_data["Size"], edgecolor = "k")
